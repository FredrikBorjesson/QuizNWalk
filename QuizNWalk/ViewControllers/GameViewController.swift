...
class GameViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    ///Starts next question and checks if quiz i over
    func nextQuestion(){
    ...
    ///Gets the question if user is whitin coordinates
    ...
    ///Prints questions and answers to view
    ...
    ///Updates mapview with the new annotation.
